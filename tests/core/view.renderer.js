QUnit.test("View.Renderer", function (assert) {
    ...
    assert.equal(headerHtml, "<tr class='grid-header-row'><td style='width:27px;height:20px' class='grid-header-cell grid-cursor-pointer'><div class='grid-header-cell-div'><span class='grid-column-name'>" + column.name + "</span></div><span class='grid-resizable-handle'></span></td></tr>", "buldHeaderColumnsHtml");
